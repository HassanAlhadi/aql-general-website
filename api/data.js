      ...
      designs: [
        {
          ...
          status: 'blocked',
          statusLabel: '🔴 وقف قبل الطباعة — تدقيق 3 سبتمبر كشف غلطتين حرجتين',
          updated: '2026-09-03',
          facts: [
            'الشعار مطبوع "Allora" بحرفين L — الاسم الرسمي "Alora" بحرف واحد',
            'رقم الشكاوى بالعربي ٠١٠٠٠٩٩٨٥٦ (10 أرقام) ناقص صفر عن الإنجليزي 01000099856 (11 رقماً)',
            'الباركود سليم (تحقّق EAN-13) · جدول القيم الغذائية شبه سليم عدا السكريات (9.5% مطبوعة مقابل ~4.2% محسوبة)',
          ],
          note: 'اعتمدها Abdelrazek Omar 3 سبتمبر (Approved as data) قبل التدقيق. أنت اتحطيت CC بس بلا رد ظاهر منك. ⚠️ تناقض إضافي: طلب خامات لاحق من Wael Moustafa لإنتاج 10 آلاف وحدة لسه بيسمّيها "Jar 380gm"/"Tray 380gm" رغم اعتماد 360 جم. الملف الكامل بالتدقيق في السجل الداخلي.',
        },
        {
